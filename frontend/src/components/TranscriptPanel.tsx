  ...
  return (
    <div className="flex flex-col h-full min-h-[360px] p-6 bg-white border border-zinc-150 rounded-2xl shadow-sm dark:bg-zinc-900 dark:border-zinc-800">
      ...
      <button
        ...
        className="w-full py-3 px-4 rounded-xl text-sm font-medium text-white bg-zinc-950 hover:bg-zinc-850 dark:bg-zinc-100 dark:text-black dark:hover:bg-zinc-200 transition-colors disabled:opacity-50 disabled:cursor-not-allowed shadow-sm flex items-center justify-center gap-2"
      >
